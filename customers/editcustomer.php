...
<ul id="first">
    ...
    <li>
        <ul>
            <li>First Name: <input size="50"  required="required" type="text" name="firstname" value="<?php echo $customerToEdit['firstname']?>"></li>
            <li>Last Name: <input size="50"  required="required" type="text" name="lastname" value="<?php echo $customerToEdit['lastname']?>"></li>
            <li>Address Line 1: <input size="50" type="text" name="addr1" value="<?php echo $customercontToEdit['addr1']?>"></li>
            <li>Address Line 2: <input size="50" type="text" name="addr2" value="<?php echo $customercontToEdit['addr2']?>"></li>
            <li>City: <input size="50" type="text" name="city" value="<?php echo $customercontToEdit['city']?>"></li>
            <li>State: <input size="50" type="text" name="state" value="<?php echo $customercontToEdit['state']?>"></li>
            <li>Zip Code: <input size="50" type="number" name="zipcode" value="<?php echo $customercontToEdit['zipcode']?>"></li>
            <li>Phone 1: <input size="50" type="number" name="phone1" value="<?php echo $customercontToEdit['phone1']?>"></li>
            <li>Phone 2: <input size="50" type="number" name="phone2" value="<?php echo $customercontToEdit['phone2']?>"></li>
            <li>Email Address: <input size="50"  type="email" name="email" value="<?php echo $customercontToEdit['email']?>"></li>
        </ul>
    </li>       
</ul><!-- /Contact info -->
<ul id="accordion">
    ...
    <li>
        <ul>
            <li>Employer Name: <input size="50" type="text" name="employer_name" value="<?php echo $customercontToEdit['employer_name']?>"></li>
            <li>Position Title: <input size="50" type="text" name="position_title" value="<?php echo $customercontToEdit['position_title']?>"></li>
            <li>Department: <input size="50" type="text" name="department" value="<?php echo $customercontToEdit['department']?>"></li>
            <li>Area of Expertise: <input size="50" type="text" name="area_of_expertise" value="<?php echo $customercontToEdit['area_of_expertise']?>"></li>
            <li>Work Address: <input size="50" type="text" name="work_address" value="<?php echo $customercontToEdit['work_address']?>"></li>
            <li>Work City: <input size="50" type="text" name="work_city" value="<?php echo $customercontToEdit['work_city']?>"></li>
            <li><?php include('../_includes/work_state_conditional.php'); ?></li>
            <li>Work Zip Code: <input size="50" type="number" name="work_zip" value="<?php echo $customercontToEdit['work_zip']?>"></li>
            <li>Work Phone: <input size="50" type="number" name="work_phone" value="<?php echo $customercontToEdit['work_phone']?>"></li>
            <li>Work Email: <input size="50" type="email" name="work_email" value="<?php echo $customercontToEdit['work_email']?>"></li>
...
<ul id="accordion">
    ...
    <li>
        <ul>
            ...
            <li>Password: <input size="50" type="text" name="password" value="<?php echo $customerToEdit['password']?>"></li>
            <li>Referral Method: 
