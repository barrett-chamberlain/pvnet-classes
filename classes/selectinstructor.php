...
<h3>SELECT AN INSTRUCTOR FOR THE CLASS<br />
==============
</h3>
...
<?php echo '<a href=addinstructor.php?instructorid=' . $classes['id'] . '&classid=' . $_GET['id'] . '>SELECT</a></div><div class="classRecord">' . ' # ' . $classes['id'] . '</div><div class="classID">' . $classes['firstname'] . '</div><div class="className">' . $classes['lastname'] . '</div></div>';
$i++;
}
?>
</div><!-- .classRow -->
