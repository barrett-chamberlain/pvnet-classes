...
$result = array();
$sql = "SELECT *, COUNT(firstname), COUNT(lastname)
FROM customers
GROUP BY firstname, lastname
HAVING COUNT(firstname) > 1 and COUNT(lastname) > 1;";
 // echo $sql; exit;
...
header('Content-Disposition: attachment;filename="customer_duplicates.xls"'); 
